         ...
         <div class="dcontainer">
           ...
           <div class="row r-style">
               <div class="col-xs-5 col-xs-offset-3">
                ...
                $s= mysqli_fetch_array($x) or die(mysqli_error($con));
                $t=$s['name'];
                $j= mysqli_query($con, "Select * from register where name='$t'")  or die(mysqli_error($con));
                $i=mysqli_fetch_array($j) or die(mysqli_error($con));
                ?>
                <h5>Name:<?php echo $i['name'];?></h5>
                <h5>Blood group:<?php echo $i['bgroup'];?></h5>
                <h5>Sex:<?php echo $i['sex'];?></h5>
                <h5>City:<?php echo $i['city'];?></h5>
                <h5>D.O.B:<?php echo $i['dob'];?></h5>
